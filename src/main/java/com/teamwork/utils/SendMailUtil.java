...
public class SendMailUtil {
    ...
    public boolean sendHtmlMail(String receiveEmail,String name,String code){
        ...
        try {
            ...
            messageHelper.setSubject("Team-Work团队管理系统");//设置邮件的主题
            ...
            String str="<!DOCTYPE html><html><head><meta charset='UTF-8'></head><body>"
                    ...
                    +"<p style='text-indent:2em;font-size:20px'>欢迎使用Team-Work团队管理系统，您本次的验证码是"
                    ...
                    +"<a href='http://www.baidu.com' style='font-size18px;'>Team-Work团队管理系统</a></p>"
